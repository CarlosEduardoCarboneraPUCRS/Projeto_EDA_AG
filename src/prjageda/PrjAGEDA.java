...
public class PrjAGEDA {
    ...
    public static void main(String[] args) throws Exception, Throwable {
         ...
         * >>>>>>  ATENÇÃO <<<<<<<
         * 
         * OBSERVAÇÃO: 1°) A Opção DEEPCOPY não funciona para objetos do tipo "ArrayList<>", ou seja, apartir do elemento 1 o mesmo guradará as referências do Objetos vinculado
         *             2°) Cuidar com o nível de profundidade da árvore, quando do "CROSSOVER E DA MUTAÇÃO", poderá ocorrer que o nível de profundidade da árvore DUPLIQUE.
         *             
         -------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
